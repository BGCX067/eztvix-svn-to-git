...
{
    /// <summary>
    /// <c>TreeViewFolderBrowserDataProvider</c> is the standard data provider for <see cref="TreeViewFolderBrowser"/> which is based on <see cref="ROOT.CIMV2.Win32.Logicaldisk"/>, System.IO and <see cref="RootKit.Win32.SystemImageList"/>
    ...
    public class TreeViewFolderBrowserDataProvider : ITreeViewFolderBrowserDataProvider
    {
        ...
        private RootKit.Win32.SystemImageList _systemImageList;
