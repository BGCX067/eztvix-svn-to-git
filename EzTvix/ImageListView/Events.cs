...
namespace RootKit.Windows.Forms
{
    ...
    /// <param name="e">A ItemEventArgs that contains event data.</param>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public delegate void MovieItemCheckBoxClickEventHandler(object sender, MovieItemEventArgs e);
    ...
    /// </summary>
    [Serializable, ComVisible(true)]
    public class MovieItemEventArgs
    {
        private MovieListViewItem mItem;

        /// <summary>
        /// Gets the ImageListViewItem that is the target of the event.
        /// </summary>
        public MovieListViewItem Item { get { return mItem; } }
