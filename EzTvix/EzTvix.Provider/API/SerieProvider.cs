...
{
    abstract public class SerieProvider : ProviderWorker, iSerieProvider
    {
        ...
        #region *** properties ***
        protected XmlDocument SerieXml = new XmlDocument();
        protected Movies _serieList;
        public Movies MovieList { get { return _serieList; } }
