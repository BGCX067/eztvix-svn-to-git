...
{
    //public class OldMovies : IDictionary<int, OldMovie>
    //{


    //    private Dictionary<int, OldMovie> dico = new Dictionary<int, OldMovie>();
    ...
    //        foreach (KeyValuePair<int, OldMovie> kvp in dico)
    //        {
    ...
    //    public bool Contains(OldMovie item)
    //    {
    //        //ICollection<KeyValuePair<TKey, TValue>>
    //        return dico.ContainsKey(item.ID);
    //    }
    //    public void Add(OldMovie value)
    //    {
    //        dico.Add(value.ID, value);
    //    }
    //    public bool Remove(OldMovie value)
    //    {
