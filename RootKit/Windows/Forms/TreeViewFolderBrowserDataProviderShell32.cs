...
{
    /// <summary>
    /// <c>TreeViewFolderBrowserDataProvider</c> is the shell32 interop data provider for <see cref="TreeViewFolderBrowser"/> which is based on <see cref="ROOT.CIMV2.Win32.Logicaldisk"/>, <c>Shell32</c> Interop and <see cref="RootKit.Win32.SystemImageList"/>
    ...
    public class TreeViewFolderBrowserDataProviderShell32 : TreeViewFolderBrowserDataProvider
    {
        ...
        private RootKit.Win32.Shell32Namespaces _shell = new RootKit.Win32.Shell32Namespaces();
