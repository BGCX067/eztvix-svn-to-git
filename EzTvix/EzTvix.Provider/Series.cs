...
{
    public class Series : IDictionary<int, Serie>
    {


        private Dictionary<int, Serie> dico = new Dictionary<int, Serie>();
        ...
        public ICollection<Serie> Values { get { return dico.Values; } }
        ...
        public void Add(int key, Serie value)
        {
            dico.Add(key, value);
        }
        //
        ...
        //   System.ArgumentNullException:
        //     key is null.
        public bool TryGetValue(int key, out Serie value)
        {
        ...
        public void Add(KeyValuePair<int, Serie> item)
        {
        ...
        //     false.
        public bool Contains(KeyValuePair<int, Serie> item)
        {
            //ICollection<KeyValuePair<TKey, TValue>>
        ...
        //     array.
        public void CopyTo(KeyValuePair<int, Serie>[] array, int arrayIndex)
        {
            //
        }
        //
        ...
        //   System.NotSupportedException:
        //     The System.Collections.Generic.ICollection<T> is read-only.
        public bool Remove(KeyValuePair<int, Serie> item)
        {
        ...
        public IEnumerator<KeyValuePair<int, Serie>> GetEnumerator()
        {
        ...
        //        foreach (KeyValuePair<int, Serie> kvp in dico)
        //        {
        //            try
        //            {
        ...
        public bool Contains(Serie item)
        {
            //ICollection<KeyValuePair<TKey, TValue>>
        ...
        public bool Remove(Serie value)
        {
