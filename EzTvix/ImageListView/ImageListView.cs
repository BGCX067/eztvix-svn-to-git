...
namespace RootKit.Windows.Forms
{
    ...
    public partial class ImageListView : Control
    {
        ...
        public ImageListView()
        {
            ...
            ResourceManager manager = new ResourceManager("RootKit.Windows.Forms.ImageListViewResources",
        ...
        /// </summary>
        /// <param name="e">A ItemEventArgs that contains event data.</param>
        protected virtual void OnMovieItemCheckBoxClick(MovieItemEventArgs e)
        {
            if (MovieItemCheckBoxClick != null)
                MovieItemCheckBoxClick(this, e);
        }
        /// <summary>
        /// Raises the ItemCheckBoxClick event.
        /// </summary>
        ...
        /// </summary>
        /// <param name="item">The checked item.</param>
        internal virtual void OnItemCheckBoxClickInternal(MovieListViewItem item)
        {
            OnMovieItemCheckBoxClick(new MovieItemEventArgs(item));
        }
        /// <summary>
        ...
        /// </summary>
        [Category("Action"), Browsable(true), Description("Occurs when the user clicks an item checkbox.")]
        public event MovieItemCheckBoxClickEventHandler MovieItemCheckBoxClick; 
        /// <summary>
